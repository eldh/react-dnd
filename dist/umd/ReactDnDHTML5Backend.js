(function (global, factory) {
	...
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.ReactDnDHTML5Backend = factory());
	...
	var EnterLeaveCounter = /*#__PURE__*/function () {
	  ...
	  _createClass(EnterLeaveCounter, [{
	    ...
	    value: function enter(enteringNode) {
	      ...
	      this.entered = (0, js_utils.union)(this.entered.filter(isNodeEntered), [enteringNode]);
	    ...
	    value: function leave(leavingNode) {
	      var previousLength = this.entered.length;
	      this.entered = (0, js_utils.without)(this.entered.filter(this.isNodeInDocument), leavingNode);
	      return previousLength > 0 && this.entered.length === 0;
	    }
	  }, {
	    key: "reset",
	...
	var isFirefox = (0, js_utils.memoize)(function () {
	  return /firefox/i.test(navigator.userAgent);
	});
	exports.isFirefox = isFirefox;
	var isSafari = (0, js_utils.memoize)(function () {
	...
	function isImageNode(node) {
	  ...
	  return node.nodeName === 'IMG' && ((0, BrowserDetector.isFirefox)() || !((_document$documentEle = document.documentElement) === null || _document$documentEle === void 0 ? void 0 : _document$documentEle.contains(node)));
	}
	...
	function getDragPreviewSize(isImage, dragPreview, sourceWidth, sourceHeight) {
	  ...
	  if ((0, BrowserDetector.isSafari)() && isImage) {
	...
	function getDragPreviewOffset(sourceNode, dragPreview, clientOffset, anchorPoint, offsetPoint) {
	  ...
	  var calculateYOffset = function calculateYOffset() {
	    var interpolantY = new MonotonicInterpolant_1.MonotonicInterpolant([0, 0.5, 1], [// Dock to the top
	  ...
	  var calculateXOffset = function calculateXOffset() {
	    ...
	    var interpolantX = new MonotonicInterpolant_1.MonotonicInterpolant([0, 0.5, 1], [// Dock to the left
	...
	var nativeTypesConfig_1 = createCommonjsModule(function (module, exports) {
	...
	var NativeTypes$1 = _interopRequireWildcard(NativeTypes);
	...
	var nativeTypesConfig = (_nativeTypesConfig = {}, _defineProperty(_nativeTypesConfig, NativeTypes$1.FILE, {
	  exposeProperties: {
	  ...
	  matchesTypes: ['Files']
	}), _defineProperty(_nativeTypesConfig, NativeTypes$1.URL, {
	  exposeProperties: {
	    urls: function urls(dataTransfer, matchesTypes) {
	      return (0, getDataFromDataTransfer_1.getDataFromDataTransfer)(dataTransfer, matchesTypes, '').split('\n');
	    }
	  },
	  matchesTypes: ['Url', 'text/uri-list']
	}), _defineProperty(_nativeTypesConfig, NativeTypes$1.TEXT, {
	  exposeProperties: {
	    text: function text(dataTransfer, matchesTypes) {
	      return (0, getDataFromDataTransfer_1.getDataFromDataTransfer)(dataTransfer, matchesTypes, '');
	    }
	  },
	...
	function createNativeDragSource(type, dataTransfer) {
	  var result = new NativeDragSource_1.NativeDragSource(nativeTypesConfig_1.nativeTypesConfig[type]);
	...
	var OptionsReader_1 = createCommonjsModule(function (module, exports) {
	...
	var HTML5BackendImpl_1 = createCommonjsModule(function (module, exports) {
	...
	var HTML5BackendImpl = /*#__PURE__*/function () {
	  function HTML5BackendImpl(manager, globalContext) {
	    ...
	    this.getSourceClientOffset = function (sourceId) {
	      ...
	      return source && (0, OffsetUtils.getNodeClientOffset)(source) || null;
	    };
	    ...
	    this.handleTopDragStart = function (e) {
	      ...
	      var clientOffset = (0, OffsetUtils.getEventClientOffset)(e); // Avoid crashing if we missed a drop event or our previous drag died
	      ...
	      var nativeType = (0, NativeDragSources.matchNativeItemType)(dataTransfer);
	      ...
	      if (_this.monitor.isDragging()) {
	        if (dataTransfer && typeof dataTransfer.setDragImage === 'function') {
	          ...
	          if (dragPreview) {
	            ...
	            var dragPreviewOffset = (0, OffsetUtils.getDragPreviewOffset)(sourceNode, dragPreview, clientOffset, anchorPoint, offsetPoint);
	    ...
	    this.handleTopDragEnter = function (e) {
	      ...
	      if (!(0, BrowserDetector.isFirefox)()) {
	        // Don't emit hover in `dragenter` on Firefox due to an edge case.
	        // If the target changes position as the result of `dragenter`, Firefox
	        // will still happily dispatch `dragover` despite target being no longer
	        // there. The easy solution is to only fire `hover` in `dragover` on FF.
	        _this.actions.hover(dragEnterTargetIds, {
	          clientOffset: (0, OffsetUtils.getEventClientOffset)(e)
	        });
	      }
	    ...
	    this.enterLeaveCounter = new EnterLeaveCounter_1.EnterLeaveCounter(this.isNodeInDocument);
	  }
	  /**
	  ...
	  _createClass(HTML5BackendImpl, [{
	    ...
	    value: function beginDragNativeItem(type, dataTransfer) {
	      this.clearCurrentDragSourceNode();
	      this.currentNativeSource = (0, NativeDragSources.createNativeDragSource)(type, dataTransfer);
	...
	Object.defineProperty(exports, "getEmptyImage", {
	  enumerable: true,
	  get: function get() {
	    return getEmptyImage_1.getEmptyImage;
	  }
	});
	...
	exports.NativeTypes = NativeTypes$1;
	...
	var HTML5Backend = function createBackend(manager, context) {
	  return new HTML5BackendImpl_1.HTML5BackendImpl(manager, context);
	};

	exports.HTML5Backend = HTML5Backend;
	});

	var index = /*@__PURE__*/getDefaultExportFromCjs(esm);
